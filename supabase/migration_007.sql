-- Migration 007: Add is_ngoai_khoa flag to views
-- BU determined via contract_items.ma_ncc → shared.dm_vat_tu.bu
-- Target BUs: CH&CS, CTTM & CTUT, THNS & CSVT

-- 1. Update expiry view: add is_ngoai_khoa flag
...
-- 2. Update items view: add is_ngoai_khoa flag (preserving compound ma_ncc logic)
