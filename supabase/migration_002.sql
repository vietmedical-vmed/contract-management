-- Migration 002: Sort contracts by status group + add don_gia to items view
-- Status order: Sắp hết hạn (1) → Còn hạn (2) → Hết hạn (3)

-- 1. Update expiry view: add status_order for grouped sorting
...
-- 2. Update items view: must DROP first because adding column in middle
